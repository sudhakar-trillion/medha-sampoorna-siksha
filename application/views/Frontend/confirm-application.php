  ...
  <div style="width:60%; float:left">
    ...
    <tr >
      ...
      <td ><p><strong>District:</strong> <?PHP echo str_replace("DISTRICT",'',$DistrictName);?><br>
          <strong>Mandal:</strong> <strong><?PHP echo str_replace("(MANDAL)","",$MandalName);?></strong><br>
  ...
  <div style="width:40%; float:left">
    ...
    <tr >
     <!-- <td  align="left" style="padding-bottom:50px;"><img src="resources/frontend-resources/img/signature.jpg" style="border:1px solid #ddd; padding:7px; margin-right:15px;" /></td>-->
      <td  align="right" style="padding-bottom:50px;"><img  src="<?PHP echo $PicPath?>" style="width:270px; border:1px solid #ddd; padding:7px; margin-right:15px;" /></td>
    </tr>
   <!-- <tr  >
   ...
   <tr >
      <td ><a href="<?PHP echo base_url('edit-application/'.$this->uri->segment(2))?>" style="padding:9px 6px; background:#549e57; color:#fff; text-decoration:none;">Edit Application</a></td>
      <td >
      
      <a href="<?PHP echo base_url()?>" style="padding:9px 15px;background:#549e57; color:#fff; text-decoration:none;">New </a></td>

     
    </tr>
    
    <tr >
      <td ><a href="<?PHP echo base_url('application-preview/'.$this->uri->segment(2))?>" style="padding:9px 6px; background:#549e57; color:#fff; text-decoration:none;">Download Applicaiton</a></td>
    ...
    <tr>
      ...
      <td colspan="2" style="color:#F00"><strong>Note :- Application no. Should remember for further information</strong></td>
    </tr>
